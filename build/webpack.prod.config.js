...
module.exports = webpackMerge(webpackBaseConfig, {
        ...
        rules: [
            {
                ...
                use: ExtractTextWebpackPlugin.extract({
                    ...
                    use: [
                        ...
                        ({ realResource }) => {
                            return /\/views\/pc\//.test(realResource) ? 'px2rem-loader?remUnit=192' : 'px2rem-loader?remUnit=75'
                        },
                        'less-loader'
                    ]
                })
    ...
    plugins: [
        ...
        new ExtractTextWebpackPlugin({
            filename: `${config.dir.chunk}/[name].[hash:5].min.css`
        }),

        new OptimizeCss(),

        new CleanWebpackPlugin({cleanOnceBeforeBuildPatterns: ['**/*', '!static*','!static/*']})
    ],
